  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="glass border-b border-white/5 px-4 py-3 flex items-center gap-3">
        <Link href="/citizen" className="text-slate-400 hover:text-white transition-colors">←</Link>
        <div>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link href="/citizen/report/new" className="btn-primary text-sm py-1.5">
            + Report
          </Link>
        </div>
      </div>
      ...
      <div className="flex-1 relative" style={{ minHeight: "calc(100vh - 56px)" }}>
        ...
        {selected && (
          <div className="absolute top-4 right-4 z-[999] glass rounded-2xl p-4 border border-white/10 w-64">
            ...
            <Link href="/citizen/report/new" className="btn-primary w-full justify-center mt-3 text-xs py-1.5">
              Report Similar →
            </Link>
          </div>
        )}
