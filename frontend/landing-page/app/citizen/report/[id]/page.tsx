...
export default function ReportDetailPage({ params }: ReportDetailPageProps) {
    ...
    return (
      <div className="min-h-screen bg-[#050b14] p-6 flex flex-col justify-center items-center">
        <div className="max-w-md w-full glass rounded-3xl p-8 border border-red-500/20 text-center">
          ...
          <Link href="/citizen" className="btn-primary w-full justify-center text-sm py-2.5">
            Return to Dashboard
          </Link>
        </div>
      </div>
  ...
  const imageUrl = report.image_url.startsWith("http") ? report.image_url : `${API_BASE}${report.image_url}`;
