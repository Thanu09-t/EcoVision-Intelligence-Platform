    ...
    try {
      ...
      if (storedUser) {
        try {
          ...
          document.cookie = "user=" + encodeURIComponent(JSON.stringify(parsed)) + "; path=/; max-age=604800";
          setUser(parsed);
        } catch (e) {}
      }
  ...
  return (
    <div className="min-h-screen p-6 bg-[#041611] text-slate-300 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto mb-6 relative z-20">
        <Link href="/citizen" className="text-slate-400 hover:text-white text-sm flex items-center gap-1 mb-4 transition-colors">
          ← Back to Dashboard
        </Link>
      ...
      <div className="max-w-2xl mx-auto relative z-20">
        ...
        {step === 4 && predictionResult && (
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Link href="/citizen/map" className="bg-slate-800 text-white font-bold px-5 py-3 rounded-xl text-sm flex-1 justify-center text-center">
                View Map Dashboard
              </Link>
              <button
