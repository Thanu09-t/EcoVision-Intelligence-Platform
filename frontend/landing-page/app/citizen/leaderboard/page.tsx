...
export default function LeaderboardPage() {
  ...
  useEffect(() => {
    ...
    if (!token) { window.location.href = "/citizen/login"; return; }
    if (storedUser) {
    ...
    <div className="min-h-screen">
      ...
      <div className="sticky top-0 z-30 glass border-b border-white/5 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/citizen" className="text-slate-400 hover:text-white text-sm">← Back</Link>
          <div>
        ...
        <Link href="/citizen/report/new" className="btn-primary text-sm py-2">+ Report</Link>
      </div>
      ...
      <div className="p-6 max-w-2xl mx-auto space-y-6">
        ...
        <div className="glass rounded-2xl p-5 border border-white/5">
          ...
          <div className="mt-4 pt-4 border-t border-white/5">
            <Link href="/citizen/report/new" className="btn-primary w-full justify-center py-2.5 text-sm">
              📸 Report Garbage Now
            </Link>
          </div>
        </div>
