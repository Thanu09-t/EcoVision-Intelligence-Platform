      ...
      <header className="bg-[#041611]/90 backdrop-blur-md border-b border-white/10 px-6 py-3.5 sticky top-0 z-40 shadow-xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs font-bold text-slate-300 font-mono">
            <Link href="/citizen" className="text-[#5CE0A5] border-b-2 border-[#5CE0A5] pb-1">
              Dashboard
            </Link>
            ...
            <Link href="/citizen/map" className="hover:text-[#5CE0A5] transition-colors">
              🗺️ Map View
            </Link>
            <Link href="/citizen/achievements" className="hover:text-[#5CE0A5] transition-colors">
              🏆 Eco Rewards
            </Link>
          </nav>
