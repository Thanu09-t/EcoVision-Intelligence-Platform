    ...
    <div className="min-h-screen bg-[#041611] text-slate-100 flex flex-col font-sans relative overflow-hidden">
      ...
      <div className="sticky top-0 z-30 bg-[#041611]/90 backdrop-blur-md border-b border-white/10 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/citizen" className="text-slate-400 hover:text-white text-xs font-mono">← Back to Dashboard</Link>
          <div>
        ...
        <MagneticButton>
          <Link href="/citizen/leaderboard" className="bg-[#5CE0A5] text-slate-950 font-extrabold text-xs px-4 py-2 rounded-xl">
            🏆 City Leaderboard
          </Link>
        </MagneticButton>
      </div>
